...
void States::run_record_function(const char* content) {
    ...
    std::shared_ptr<States> shared_this = shared_from_this();
    std::thread([shared_this, mode, threshold](){ apiClient_.send_post_request(apiClient_.create_request(latitude, longitude, threshold, mode)); }).detach();
...
void States::run_standby_function() {
    ...
    double threshold = ledController_.get_max_distance_as_lat_long_deg();
    std::shared_ptr<States> shared_this = shared_from_this();
    std::thread([shared_this, mode, threshold](){ apiClient_.send_post_request(apiClient_.create_request(0.0, 0.0, threshold, mode)); }).detach();
